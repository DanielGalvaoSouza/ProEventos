...
namespace ProEventos.Persistence.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            AuditoriumsQueryRSContext<DTO.DTOAuditoriums>.DataSeedingAuditoriums(ref migrationBuilder);
            EventsQueryRSContext<DTO.DTOEvents>.DataSeedingEvents(ref migrationBuilder);
